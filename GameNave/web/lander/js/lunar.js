var dia = new Date();
var dia2 = new Date();
var fechaInicio = dia.getDate()+'/'+(dia.getMonth() +1)+'/'+
        dia.getFullYear()+' '+dia.getHours()+':'+dia.getMinutes()+':'+
        dia.getSeconds();
var fechaFinal = dia2.getDate()+'/'+(dia2.getMonth() +1)+'/'+
dia2.getFullYear()+' '+dia2.getHours()+':'+dia2.getMinutes()+':'+
dia2.getSeconds();;
// Moon
var moon = {};
moon.mtop = 50;
